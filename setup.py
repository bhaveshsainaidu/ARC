"""
ARC (Adaptive Real-Time Cognitive Agent) — one-time setup.
...
The optional local wake word ("Hey Arc") is NOT installed here — it's a
...
def main() -> None:
    print(f"⚙  ARC setup — detected OS: {OS or 'unknown'}")
    ...
    print("   3) (Optional) Enable 'Hey Arc' from ⚙ → WAKE WORD.")
